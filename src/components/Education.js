...
export default function Education() {
    ...
    <img src={bamu} alt={"school_logo"} className={"education-roundedimg"}/>
      ...
      <h3>BE in Computer Science Engineering</h3>
        ...
        <Timeline.Item label="2012 - 2014">
            <div className="container">
    <div className="content">
    <img src={sk} alt={"school_logo"} className={"education-roundedimg"}/>
  ...
  <Timeline.Item label="2010">
            <div className="container">
    <div className="content">
    <img src={saint} alt={"school_logo"} className={"education-roundedimg"}/>
